...
source <(wget -qO- https://raw.githubusercontent.com/alfredfenglq/Seedbox-Components/main/seedbox_installation.sh)
...
while getopts "u:p:c:q:l:rbvx3oh" opt; do
  case ${opt} in
	...
	h ) # process option help
		...
		source <(wget -qO- https://raw.githubusercontent.com/alfredfenglq/Seedbox-Components/main/Torrent%20Clients/qBittorrent/qBittorrent_install.sh)
		seperator
		info "Options:"
